...
func Load() *Config {
	...
	return &Config{
		TCPAddr:          envStr("GT06_TCP_ADDR", ":7019"),
		HTTPAddr:         envStr("GT06_HTTP_ADDR", ":9091"),
		RedisAddr:        envStr("REDIS_HOST", "redis") + ":" + envStr("REDIS_PORT", "6379"),
		RedisPassword:    envStr("REDIS_PASSWORD", ""),
		RedisDB:          envInt("REDIS_GT06_DB", 1),
		RedisPoolSize:    envInt("REDIS_POOL_SIZE", 100),
		StreamKey:        envStr("STREAM_KEY", "gt06:telemetry"),
		StreamMaxLen:     envInt64("STREAM_MAX_LEN", 100_000),
		SessionPrefix:    envStr("SESSION_PREFIX", "gt06:session:"),
		OnlineZKey:       envStr("ONLINE_Z_KEY", "gt06:online"),
		CmdChannel:       envStr("CMD_CHANNEL", "gt06:cmd:"),
		...
		DBDeviceTypeID: envInt64("DB_DEVICE_TYPE_ID", 2),
